...
class _ShowLessonPageState extends State<ShowLessonPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text("${currentLesson.title}", style: TextStyle(color: Colors.blue),) 
      ...
      body: Column(
        children: [
          _lessonContent(context, currentLesson),
          _footer(context)
        ],
      )
   );
          ...
          child: Row(
            ...
            children: [
              MaterialButton(
                ...
                child: Text("Siguiente lección",style: TextStyle(color: Colors.white),),
                onPressed: (){
                  Navigator.pushNamed(context, 'showExperiment');  
                }),
            ],
          ),
        );
